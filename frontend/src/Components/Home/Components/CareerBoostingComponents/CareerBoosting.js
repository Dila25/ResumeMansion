        ...
        <div className='continer_main_box'>
            <div className='container'>
                <div className='card_main'>
                    <p className='main_topic_boosting'>Career-Boosting Services to Help You Stand Out</p>
                    <p className='para_boosting'>Our tailored services—resume writing, cover letter creation, LinkedIn optimization, and career advice—are designed to showcase your strengths and help you make a lasting impression in today’s job market.</p>
                    <div className='boost_card_container'>
                        <div className='boost_card card_boost_one'>
                            ...
                            <p className='boot_card_pera'>Stand out with a resume that highlights your skills and experience. Our experts create impactful resumes to help you land interviews faster.</p>
                            <button className="boost_card_btn">Learn more</button>
                        </div>
                        ...
                        <div className='boost_card card_boost_two'>
                            ...
                            <p className='boot_card_pera'>Elevate your application with a custom cover letter. Our writers craft letters that showcase your achievements and align with your target role.</p>
                            <button className="boost_card_btn">Learn more</button>
                        </div>
                        ...
                        <div className='boost_card card_boost_three'>
                            ...
                            <p className='boot_card_pera'>Attract recruiters with an optimized LinkedIn profile. We enhance your profile with targeted keywords and a strong brand to expand your reach.</p>
                            <button className="boost_card_btn_thre">Learn more</button>
                        </div>
                        ...
                        <div className='boost_card card_boost_four'>
                            ...
                            <p className='boot_card_pera'>Get expert guidance to achieve your career goals. Our tailored coaching covers interview prep, job search strategies, and more to boost your success.</p>
                            <button className="boost_card_btn_last">Learn more</button>
                        </div>
                    </div>
                </div>
            </div>
